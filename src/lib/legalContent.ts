...
6.2 Payment Processing. Gift card transactions are processed by third-party payment processors. AuraLink does not store full credit card numbers. You agree to the payment processor’s terms in addition to ours.

6.3 Spark Plan Commission. For customers on the Spark (Free) plan, AuraLink charges a platform commission on each gift card sale as described in Section 3.6. Paid plans (Maverick and Supernova) do not incur this platform commission, though standard payment processor fees still apply.
...
6.5 Liability. AuraLink is not liable for lost, stolen, or fraudulently used gift cards unless caused by our gross negligence.`,
  },
  {
    id: "loyalty",
...
8.2 Influencer Management. You may use AuraLink tools to track influencer campaigns. You are responsible for ensuring influencers disclose material connections in compliance with FTC guidelines.`,
  },
  {
    id: "ai",
...
9.3 Data Use for AI. AI features may process customer inquiries and your business content to generate responses. This processing is governed by our Privacy Policy.`,
  },
  {
    ...
    content: `10.1 Your Customer Data. You are the “data controller” under privacy laws like GDPR and CCPA; AuraLink acts as your “data processor.”
...
10.4 Security. AuraLink implements industry-standard security measures. You are responsible for maintaining the security of your account credentials.`,
  },
  {
    id: "sms",
...
11.2 Your Responsibility. AuraLink provides the technical capability to send messages. You are responsible for the content of those messages and ensuring legal permission to send them.`,
  },
  {
    id: "ip",
    title: "12. Intellectual Property",
    content: `12.1 AuraLink IP. The platform, code, designs, logos, and documentation belong to AuraLink. You receive a limited, non-exclusive license to use the platform during your subscription.
...
14.3 Liability Cap. AuraLink’s total liability is limited to the amount you paid us in the 12 months preceding the claim, or $100 if you are on the free Spark plan.
...
14.4 Excluded Damages. We are not liable for indirect, incidental, special, consequential, or punitive damages.`,
  },
  {
    ...
    content: `You agree to defend, indemnify, and hold harmless AuraLink from any claims arising from:
...
16.3 Class Action Waiver. You agree to resolve disputes on an individual basis and not as part of a class action.`,
  ...
  },
  {
    ...
    content: `These Terms, together with our Privacy Policy and DPA, constitute the entire agreement between you and AuraLink. If any part is found invalid, the rest remains in effect.
...
export const privacySections: LegalSection[] = [
  {
    ...
    content: `AuraLink (“we,” “us,” or “our”) respects your privacy and is committed to protecting your personal data. This Privacy Policy explains how we collect, use, store, and share information when you use the AuraLink platform and related services.

This policy applies to all users of AuraLink, including business owners and the customers of those businesses who interact with AuraLink-powered microsites, gift cards, loyalty programs, and other features.`,
  },
  {
...
2.3 Customer Data — As a business using AuraLink, you may collect personal information from your own customers through your microsite. You are the “data controller” for this information; AuraLink acts as your “data processor.”`,
  },
  {
    id: "how-we-use",
    title: "3. How We Use Your Information",
    content: `We use the information we collect to provide, operate, and maintain the AuraLink platform; process payments and manage subscriptions; send transactional emails and service updates; provide customer support; improve and develop new features; ensure security and prevent fraud; and comply with legal obligations.
...
5.4 Business Transfers — If AuraLink is involved in a merger or acquisition, your information may be transferred as part of that transaction.`,
  },
  {
    id: "ai-data",
  ...
  },
  {
    ...
    content: `We use cookies for authentication, preferences, analytics, and to deliver relevant content. You can manage cookie preferences through your browser. As a business using AuraLink, you are responsible for ensuring your microsite complies with applicable cookie consent laws.`,
  },
  {
    id: "security",
  ...
  },
  {
    ...
    content: `AuraLink integrates with third-party services such as Google Maps, social media platforms, reservation providers, and review sites. This Privacy Policy does not cover the data practices of those third parties.`,
  },
  {
    id: "children",
    title: "11. Children’s Privacy",
    content: `AuraLink is not intended for use by individuals under the age of 18, and we do not knowingly collect personal data from children.`,
  },
  {
    id: "your-rights",
  ...
  },
  {
    ...
    content: `For business customers subject to GDPR, CCPA, or similar regulations, AuraLink acts as a data processor. Our DPA is incorporated by reference into our Terms of Service. If you require a signed DPA, contact privacy@auralink.com.`,
  },
  {
    id: "international",
    title: "14. International Data Transfers",
    content: `AuraLink is based in the United States. If you access the Services from outside the United States, your data may be transferred to, stored, and processed in the United States. We use appropriate safeguards such as Standard Contractual Clauses.`,
  },
  {
    id: "changes",
