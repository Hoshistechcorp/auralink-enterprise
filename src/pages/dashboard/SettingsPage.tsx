              ...
              <div className="p-6 rounded-2xl bg-card border">
                ...
                <div className="mt-6 p-5 rounded-xl bg-muted/30 border">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="text-sm font-semibold">Microsite Action Buttons</h4>
                  </div>
                  <p className="text-xs text-muted-foreground mb-4">Configure what happens when visitors tap Call, Message, or Directions on your microsite.</p>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-xs font-medium text-muted-foreground mb-1.5 block">Phone Number (for Call)</label>
                      <div className="relative">
                        <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                        <input
                          value={contact.phone}
                    ...
                    <div>
                      <label className="text-xs font-medium text-muted-foreground mb-1.5 block">SMS Number (for Message)</label>
                      <div className="relative">
                        <MessageCircle className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                        <input
                          value={contact.smsNumber}
                          onChange={(e) => setContact({ ...contact, smsNumber: e.target.value })}
                          placeholder="(212) 555-0198"
                          className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-muted/50 border text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="123 Grand Ave, New York, NY"
                          className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-muted/50 border text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="www.bellavistanyc.com"
                          className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-muted/50 border text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                        />
                      </div>
                    </div>
