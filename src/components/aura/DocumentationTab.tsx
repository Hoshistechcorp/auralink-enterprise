...
const sections: DocSection[] = [
  {
    ...
    features: [
      ...
      "Activity feed with recent customer interactions",
      "Revenue and performance KPIs",
      "Multi-location switcher in the top bar",
  ...
  },
  {
    ...
    features: [
      "Business Hours: Set operating hours with timezone support and special holiday schedules",
      "Menu Management: Add/edit menu items with images, prices, descriptions, and visibility toggles",
      "Photo Gallery: Upload and organize venue photos with drag-and-drop ordering",
      "Staff Profiles: Create team member cards with photos, roles, and guest ratings",
      "Events: Manage upcoming events with ticketing (price & quantity) and date/time settings",
      "Awards & Press: Showcase accolades, press mentions, and industry recognition",
      "Private Dining: Configure private dining rooms with capacity, pricing, and inquiry forms",
      "FAQs: Create and organize frequently asked questions for your microsite",
      "Social Links: Connect all your social media profiles in one place",
      "Content gated by subscription tier — locked tabs prompt upgrade",
    ],
  },
  {
    id: "card-studio",
    ...
    features: [
      "15 available card types covering every aspect of your business",
      "Drag-and-drop card reordering",
      "Toggle cards on/off to control what visitors see",
      "Live preview of your microsite layout",
      "Cards locked by tier display upgrade prompts",
      "Spark tier: 6 core cards (Details, Gift Cards, Menu, Social Links, Reviews, FAQs)",
      "Maverick tier: adds Freebie Game, Staff, Awards, Events, Popular Dishes",
      "Supernova tier: unlocks AI Concierge, Private Dining, Photo Gallery, Refer a Friend, Affiliate",
    ],
  },
  {
    id: "analytics",
    ...
    features: [
      "Visitor count and trend charts (daily, weekly, monthly)",
      "Card-level engagement metrics — views, taps, and conversion rates",
      "Top-performing content identification",
      "Revenue tracking and goal progress",
  ...
  },
  {
    ...
    features: [
      "Spin-the-wheel and scratch card prize games",
      "Configurable prize pools and win probabilities",
      "Freebie Game card on the microsite for instant engagement",
      "Prize redemption tracking and analytics",
      "Social sharing incentives for game results",
    ],
  },
  {
    id: "loyalty",
    ...
    features: [
      "Multi-tier loyalty levels (Bronze, Silver, Gold, Platinum)",
      "Points-per-visit and points-per-dollar configuration",
      "Reward catalog with redemption thresholds",
      "Member activity tracking and engagement analytics",
      "Automated milestone notifications",
      "VIP perks and exclusive offers management",
    ],
  },
  {
    id: "referrals",
    ...
    features: [
      "Unique referral link generation for each customer",
      "Refer a Friend card on the public microsite",
      "Referral tracking with conversion metrics",
      "Configurable rewards for referrer and referee",
      "Social sharing integration (SMS, email, social media)",
      "Referral leaderboard and top advocate tracking",
    ],
  },
  {
    id: "qr",
    ...
    features: [
      "One-click QR code generation for any microsite page",
      "Custom branding with logo overlay and color matching",
      "Download in multiple formats (PNG, SVG, PDF)",
      "Scan analytics with location and device tracking",
      "Batch QR code creation for multi-location setups",
  ...
  },
  {
    ...
    features: [
      "Campaign creation with custom promo codes (e.g., SARAH20)",
      "Affiliate sign-up via the microsite Affiliate card",
      "Commission rate configuration per campaign",
  ...
  },
  {
    ...
    features: [
      ...
      "Campaign assignment and brief management",
  ...
  },
  {
    ...
    features: [
      "Google Maps card integration on the microsite",
      "Local SEO audit and optimization suggestions",
      "Keyword ranking tracker for local search terms",
      "Business listing consistency checker",
      "Review response management for SEO impact",
    ],
  },
  {
    id: "reputation",
    ...
    features: [
      "Multi-platform review aggregation (Google, Yelp, TripAdvisor)",
      "Sentiment analysis with trend tracking",
      "Automated alerts for negative reviews",
      "Review response templates and AI suggestions",
  ...
  },
  {
    ...
    features: [
      "Digital gift card purchasing on the public microsite",
      "Preset and custom dollar amounts",
      "Unique gift card codes (e.g., BV-GIFT-100B)",
      "Balance lookup and partial redemption",
      "POS 'Sell Card' interface for in-house issuance",
  ...
  },
  {
    ...
    features: [
      "Quick location switcher in the dashboard header",
      "Per-location microsite customization",
      "Centralized vs. location-specific content management",
      "Cross-location performance comparison",
      "Location-specific QR codes and referral links",
    ],
  },
  {
    id: "team",
    ...
    features: [
      "Role-based access control (Admin, Manager, Coordinator, Staff)",
      "Team member invitation via email",
      "Activity logs per team member",
      "Permission management for sensitive settings",
    ],
  },
  {
    id: "enterprise",
  ...
  },
  {
    ...
    features: [
      "Three subscription tiers: Spark (Free), Maverick ($79/mo), Supernova ($149/mo)",
      "21-day free trial of Supernova for all new users",
      "Plan comparison with feature breakdown",
      "Billing history and invoice downloads",
      "Upgrade/downgrade with prorated billing",
      "Trial countdown visible on dashboard and microsite",
    ],
  },
  {
    id: "microsite",
    icon: Globe,
    title: "Public Microsite",
    ...
    features: [
      "Action Buttons: Call, Message, Directions, and Reserve — all configurable from Settings",
      "Dynamic card layout controlled by Card Studio",
      "Reviews card with real customer submissions (star ratings + comments)",
      "Gift Cards card for digital purchases",
      "Menu card with item details and pricing",
      "Freebie Game for interactive engagement",
      "Staff card with team profiles and tip links",
      "Refer a Friend and Affiliate sign-up cards",
      "AI Concierge for instant customer assistance",
      "Photo Gallery with venue imagery",
      "Trial expiry shows upgrade prompt instead of hiding cards",
      "Trial countdown banner visible to business owner",
  ...
  },
  {
    ...
    features: [
      ...
      "Business: Set industry, venues, team members, and reservation provider",
      "Microsite Action Buttons: Configure phone, SMS, address, email, and Google Maps URL",
      "Notifications: Toggle alerts for reviews, referrals, loyalty milestones, and more",
      "Appearance: Choose from 6 preset themes or create custom colors, adjust border radius and font style",
      "Security: Change password, enable two-factor authentication, manage active sessions",
      "Documentation: This guide — a full reference of every feature (you are here!)",
    ],
  },
];
